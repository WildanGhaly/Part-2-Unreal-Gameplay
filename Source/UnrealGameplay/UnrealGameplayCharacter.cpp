...
void AUnrealGameplayCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AUnrealGameplayCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AUnrealGameplayCharacter::Look);
	}
	else
	{
...
void AUnrealGameplayCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AUnrealGameplayCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
